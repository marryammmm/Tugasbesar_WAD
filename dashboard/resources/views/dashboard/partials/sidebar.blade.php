    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                ...
                <span class="menu-title">Ambulans</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                <i class="icon-disc menu-icon"></i>
                <span class="menu-title">Konsultasi Dokter</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                <i class="icon-disc menu-icon"></i>
                <span class="menu-title">Konsultasi Chatbot</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                <i class="icon-disc menu-icon"></i>
                <span class="menu-title">Artikel dan Video</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.html">
